...
Most of these come down to network reality or how wttr serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

wttr rate-limits like any public site. wttr already paces
...
Where a surface is gated, wttr reads a cookie or token you supply
...
`wttr`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what wttr actually did
